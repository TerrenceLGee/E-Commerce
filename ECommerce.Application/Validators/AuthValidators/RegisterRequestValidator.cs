...
public class RegisterRequestValidator : AbstractValidator<RegisterRequest>
{
    public RegisterRequestValidator()
    {
        ...
        RuleFor(x => x.BirthDate)
            ...
            .WithMessage("Invalid birth date, birth date must be valid");
        ...
        RuleFor(x => x.StreetNumber)
            ...
            .MaximumLength(15)
            .WithMessage("Street number cannot be longer than 15 characters");

        RuleFor(x => x.StreetName)
            .NotEmpty()
            .WithMessage("Street name is required")
            .MaximumLength(30)
            .WithMessage("Street name cannot be longer than 30 characters");

        RuleFor(x => x.City)
            .NotEmpty()
            .WithMessage("City is required")
            .MaximumLength(20)
            .WithMessage("City name cannot be longer than 20 characters");

        RuleFor(x => x.State)
            .NotEmpty()
            .WithMessage("State is required")
            .MaximumLength(20)
            .WithMessage("State name cannot be longer than 20 characters");

        RuleFor(x => x.ZipCode)
            .NotEmpty()
            .WithMessage("Zip code is required")
            .Matches("^[0-9]{5}(?:-[0-9]{4})?$")
            .WithMessage("Please enter a valid U.S. zip code format");

        RuleFor(x => x.Country)
            .NotEmpty()
            .WithMessage("Country is required")
            .MaximumLength(25)
            .WithMessage("Country name cannot be longer than 25 characters");
